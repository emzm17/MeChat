...
class OtpActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun initView() {
        ...
        verifytxt.text = getString(R.string.verify_number, phoneNumber)
        setSpannableString()
    ...
    private fun setSpannableString() {
        val span = SpannableString(getString(R.string.waiting_para, phoneNumber))
    ...
    private fun showTimer(milliesInFuture: Long) {
        ...
        mCounterDown = object : CountDownTimer(milliesInFuture, 1000) {
            ...
            override fun onTick(millisUntilFinished: Long) {
                ...
                countdown.text = "Seconds remaining: " + millisUntilFinished / 1000
